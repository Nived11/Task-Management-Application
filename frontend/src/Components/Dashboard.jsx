  ...
  const handleEditTask = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${ApiPath()}/updatetask/${userId}/${editingTask._id}`,
        {
          title: taskForm.title,
          description: taskForm.description,
        },
      ...
      <header className={`dashboard-header ${isDarkMode ? "dark" : ""}`}>
        ...
        <div className="header-right">
          ...
          <div className="user-profile">
            <button
              className={`profile-button ${isDarkMode ? "dark" : ""}`}
            ...
            <div
              className={`dropdown-menu ${isDarkMode ? "dark" : ""} ${
                isProfileOpen ? "visible" : "hidden"
              }`} >
              <button
                className={`logout-button ${isDarkMode ? "dark" : ""}`}
          ...
          <div className="sidebar-section">
            ...
            <div className={`calendar-container ${isDarkMode ? "dark" : ""}`}>
              <div className="calendar-header">
                <button
                  className={`calendar-nav-btn ${isDarkMode ? "dark" : ""}`}
              ...
              <div className="calendar-grid">
                ...
                <div className="calendar-days">
                  {generateCalendarDays().map((day, index) => (
                    <div
                      key={index}
                      className={`calendar-day ${ day ? "active" : "inactive" } ${isToday(day) ? "today" : ""} ${isDarkMode ? "dark" : ""}`}
            ...
            <div className="tasks-container">
              {filteredTasks.length === 0 ? (
                ...
                filteredTasks.map((task) => (
                  <div
                    key={task._id}
                    className={`task-item-wrapper ${isDarkMode ? "dark" : ""}`}
                  >
                    <div className={`task-item ${isDarkMode ? "dark" : ""}`}>
                      ...
                      >
                        ...
                        <span
                          className={`task-text ${isDarkMode ? "dark" : ""}`}
                        >
        ...
        <div className="modal-overlay" onClick={closeAddTaskModal}>
          ...
          >
            <div className="modal-header">
              ...
              <button
                className={`modal-close-btn ${isDarkMode ? "dark" : ""}`}
            ...
            <form onSubmit={handleSubmitTask} className="task-form">
              ...
              <div className="form-actions">
                <button
                  type="button"
                  onClick={closeAddTaskModal}
                  className={`btn-cancel ${isDarkMode ? "dark" : ""}`}
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className={`btn-submit ${isDarkMode ? "dark" : ""}`}
                >
                  Add Task
                </button>
              </div>
